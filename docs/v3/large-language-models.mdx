...
To make the library lightweight, the default LLM is BambooLLM, developed by PandasAI team themselves.
...
BambooLLM is the default LLM for PandasAI, fine-tuned for data analysis.
